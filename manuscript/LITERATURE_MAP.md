...
| **mamba3-2026** | Mamba-3: Improved Sequence Modeling using State Space Principles — Lahoti, K. Y. Li, B. Chen, C. Wang, Bick, Kolter, Dao, Gu | 2603.15569 | 2026-03-16 | — | ~6 | 3–6mo | ICLR 2026; current state of SSM recurrence — situates the Mamba2/DeltaNet/GDN arms as one generation of a fast-moving family |
...
| **absence2025** | AbsenceBench: Language Models Can't Tell What's Missing — Fu, Shrivastava, Moore, West, Tan, Holtzman | 2506.11440 | 2025-06-13 | — | ~15 | **>12mo (exception)** | the single >12-month contemporary citation: the finding that transformer attention has no token to attend to for an *absence* is load-bearing for one H3 point (unsignalled failure ≠ detected absence). See recency audit for the replacement decision. |
...
|---|---|---|---|---|---|
| **mamba2-2024** | Transformers are SSMs: Generalized Models and Efficient Algorithms Through Structured State Space Duality (Mamba-2) — Dao, Gu | 2405.21060 | 2024-05 | ~28 | The **AHN-Mamba2 arm literally is this recurrence.** Method attribution; ICML 2024. No later paper is the origin of the mechanism we run. |
...
| **mamba2023** | Mamba: Linear-Time Sequence Modeling with Selective State Spaces — Gu, Dao | 2312.00752 | 2023-12 | ~33 | Only if the manuscript names the selective-SSM lineage that Mamba-2 builds on. **Candidate to drop** — `mamba3-2026` + `mamba2-2024` may cover the lineage without it. |
